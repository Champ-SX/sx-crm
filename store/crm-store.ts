...
const MOCK_ANF_STOCK: AnfStock[] = [
  { stock_id: 'm1', board_id: 'anf-order', item: 'กระดาษปริ้นท์ RX1', description: 'PAPER DNP RX1 4*6', category: 'paper', branch: 'BACC', room: 'A64/A65/A66', qty: 2, alert_qty: 2, alert_unit: 'BOXES', checked_at: '2026-08-18', checked_by: 'Bank', reported_at: '2026-08-09', delivered_at: '2026-08-18', notes: null, sign: 'Bank' },
  { stock_id: 'm2', board_id: 'anf-order', item: 'ฟิล์มสไลด์ (ใส)', description: 'PAPER CANON FILM 4*6', category: 'paper', branch: 'BACC', room: 'A63', qty: 27, alert_qty: 10, alert_unit: 'PACKS', checked_at: '2026-08-16', checked_by: 'Nuii', reported_at: null, delivered_at: '2026-08-18', notes: null, sign: 'Bank' },
