      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">SX CRM</h1>
            <p className="text-gray-600">SIXSHEET Sales Operating System</p>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 text-center text-xs text-gray-500">
            <p>SIXSHEET © {new Date().getFullYear()}</p>
          </div>
        </div>
      </div>
    </div>
