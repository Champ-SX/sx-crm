...
function SectionHeader({ letter, title, icon: Icon, open, onToggle }: {
  ...
  return (
    ...
    >
      ...
      <span className="font-mono text-[11px] text-muted-foreground tracking-[0.16em] shrink-0">{letter}</span>
      <span className="text-[13px] font-bold text-foreground flex-1 leading-none">{title}</span>
